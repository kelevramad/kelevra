...
def get_args():
	...
	parser.add_argument('-b', '--only_breaches', dest='only_breaches', help='Return results for breaches only.', action='store_true')
	parser.add_argument('-i', '--input_path', dest='input_path', help='Path to text file that lists email addresses.')
	parser.add_argument('-o', '--output_path', dest='output_path', help='Path to output (tab deliminated) text file.')
	parser.add_argument('-p', '--only_pwned', dest='only_pwned', help='Print only the pwned email addresses.', action='store_true')
	parser.add_argument('-s', '--single_email', dest='single_email', help='Send query for just one email address.')
	parser.add_argument('-t', '--only_pastebins', dest='only_pastebins', help='Return results for pastebins only.', action='store_true')
